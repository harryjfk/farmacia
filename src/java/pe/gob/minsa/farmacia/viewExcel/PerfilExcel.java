...
public class PerfilExcel extends AbstractExcelView {
    ...
    protected void buildExcelDocument(Map<String, Object> model,
        ...
        for (Perfil perfil : perfiles) {
            ...
            aRow.createCell(0).setCellValue(perfil.getIdPerfil());
            aRow.getCell(0).setCellStyle(rowStyle);
            aRow.createCell(1).setCellValue(perfil.getNombrePerfil());
            aRow.getCell(1).setCellStyle(rowStyle);
            aRow.createCell(2).setCellValue(perfil.getActivoTexto());
