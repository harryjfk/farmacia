...
public class ParametroExcel extends AbstractExcelView {
    ...
    protected void buildExcelDocument(Map<String, Object> model, HSSFWorkbook workbook, HttpServletRequest hsr, HttpServletResponse response) throws Exception {
        ...
        for (Parametro parametro : parametros) {
            ...
            aRow.createCell(0).setCellValue(parametro.getIdParametro());
            ...
            aRow.createCell(3).setCellValue(parametro.getValor());
