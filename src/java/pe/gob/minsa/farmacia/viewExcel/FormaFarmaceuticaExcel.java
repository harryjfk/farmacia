...
public class FormaFarmaceuticaExcel extends AbstractExcelView {
    ...
    protected void buildExcelDocument(Map<String, Object> model, HSSFWorkbook workbook, HttpServletRequest hsr, HttpServletResponse response) throws Exception {
        ...
        cabeceras.add("Forma Farmaceutica");
        ...
        for (FormaFarmaceutica formaFarmaceutica : formasFarmaceuticas) {
            ...
            aRow.createCell(0).setCellValue(formaFarmaceutica.getIdFormaFarmaceutica());
            
            aRow.createCell(1).setCellValue(formaFarmaceutica.getNombreFormaFarmaceutica());
            aRow.createCell(2).setCellValue(formaFarmaceutica.getAbreviatura());
            aRow.createCell(3).setCellValue(formaFarmaceutica.getActivoTexto());
