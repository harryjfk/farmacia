...
public class TipoDocumentoMovExcel extends AbstractExcelView {
    ...
    protected void buildExcelDocument(Map<String, Object> model, HSSFWorkbook workbook, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        cabeceras.add("Tipo de Documento de Movimiento");
        ...
        for (TipoDocumentoMov tipoDocumentoMov : tiposDocumentoMov) {
            ...
            aRow.createCell(0).setCellValue(tipoDocumentoMov.getIdTipoDocumentoMov());
            aRow.getCell(0).setCellStyle(rowStyle);
            aRow.createCell(1).setCellValue(tipoDocumentoMov.getNombreTipoDocumentoMov());
            aRow.getCell(1).setCellStyle(rowStyle);
            aRow.createCell(2).setCellValue(tipoDocumentoMov.getActivoTexto());
