...
public class ConsultaMedicamentoPDF extends AbstractITextPdfView {

    public ConsultaMedicamentoPDF() {
        setDocumentHorizontal(true);
        setDocumentName("Consulta de Medicamentos Adquiridos");
        setTitulo("Consulta de Medicamentos Adquiridos");
    }
