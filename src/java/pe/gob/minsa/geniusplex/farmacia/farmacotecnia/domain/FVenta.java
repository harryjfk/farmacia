...
import pe.gob.minsa.geniusplex.farmacia.dispensacion.domain.*;
 ...
 */
@Entity
@Table(name = "Far_FVenta")
public class FVenta extends BaseEntity implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof FVenta)) {
            return false;
        }
        FVenta other = (FVenta) object;
    ...
    public BigDecimal getSubTotalPreventa() {
        ...
        subTotalPreventa = new BigDecimal(String.valueOf(getCantidad()))
                .multiply(precio);
