...
public class CorteCajaDTO implements Serializable {
    ...
    private List<FVenta> ventas = new ArrayList<FVenta>();
    ...
    public CorteCajaDTO(List<FVenta> ventas, BigDecimal totalVenta, BigDecimal totalImpuestoIGV, BigDecimal overallTotal, int cantidadAnulados, BigDecimal montoAnulados) {
    ...
    public CorteCajaDTO(List<FVenta> ventas) {
        this.ventas = ventas;
        procesar();
    }
     ...
     */
    public void setVentas(List<FVenta> ventas) {
        this.ventas = ventas;
    }
    ...
    private void actualizarAnulados(FVenta venta) {
    ...
    private BigDecimal getNetoAPagar(FVenta venta) {
    ...
    private void actualizarResumenFP(FVenta venta) throws NumberFormatException {
    ...
    public void checkPeriodo(String periodo) {
        List<FVenta> tmp = new ArrayList<FVenta>();
    ...
    private void crearVentaDTO(FVenta venta) {
