...
@Controller
@RequestMapping("/{idModulo}/consumoPaciente/*")
public class ConsumoPacienteController {
    ...
    public String listarClientes(Model model) {
        ...
        model.addAttribute("viewTitle", "Consulta de Consumo por Paciente");
        ...
        model.addAttribute("tableProperties", "idCliente,nombre,codigo,dni");
        model.addAttribute("findItem", "");
        return "ConsumoPaciente/consulta";
    }
    ...
    private List<Consumo> getConsultaData(HttpServletRequest request, long idModulo) throws NumberFormatException {
        long tipoPago = request.getParameter("tipoPago") != null ? Long.parseLong(request.getParameter("tipoPago")) : 0;
        long tipoProducto = request.getParameter("tipoProducto") != null ? Long.parseLong(request.getParameter("tipoProducto")) : 0;
        long cliente = request.getParameter("cliente") != null ? Long.parseLong(request.getParameter("cliente")) : 0;
        long medico = request.getParameter("medico") != null ? Long.parseLong(request.getParameter("medico")) : 0;
        ...
        List<Venta> lista = ventaService.ConsultaConsumoPaciente(idModulo, tipoPago, start, end, cliente, medico, tipoProducto, diagnostico);
