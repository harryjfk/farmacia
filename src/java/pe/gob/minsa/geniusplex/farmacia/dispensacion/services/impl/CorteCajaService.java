...
public class CorteCajaService extends GpServiceManager<Venta> {
    ...
    public CorteCajaDTO obtenerCorteCaja(FilterData fData) throws BusinessException {
        try {
            ...
            List<Venta> ventas = this.dynamicQuery(fData);
    ...
    public boolean eliminarPorNroOperaion(String nroOp) {
        ...
        CriteriaDelete<Venta> cd = cb.createCriteriaDelete(entityClass);
    ...
    public Venta encontrarPorNroOperacion(String nroOperacion) {
        CriteriaBuilder cb = em.getCriteriaBuilder();
