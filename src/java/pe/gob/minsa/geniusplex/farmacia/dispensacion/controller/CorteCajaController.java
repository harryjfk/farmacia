...
import pe.gob.minsa.geniusplex.farmacia.dispensacion.services.impl.CorteCajaService;
...
@Controller
@RequestMapping("/{idModulo}/cortecaja/*")
public class CorteCajaController {
    ...
    public ModelAndView reportePdf(HttpServletRequest request, HttpServletResponse response, @PathVariable long idModulo,
        ...
        ModelAndView modelAndView = new ModelAndView("CorteCajaPDF", "CorteCaja", cajaDTO);
    ...
    public ModelAndView reporteExcel(HttpServletRequest request, HttpServletResponse response, @PathVariable long idModulo,
        ...
        ModelAndView modelAndView = new ModelAndView("CorteCajaExcel", "CorteCaja", cajaDTO);
        modelAndView.addObject("fData", fData);
        return modelAndView;
    }
