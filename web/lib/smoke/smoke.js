		...
		if (f.type === 'prompt'){
			prompt = 
				'<div class="dialog-prompt">'+
					'<input class="form-control" id="dialog-input-'+f.newid+'" type="text" ' + (f.params.value ? 'value="' + f.params.value + '"' : '') + ' />'+
				'</div>';
		}
			...
			if (f.type === 'alert'){
				...
				if (f.params.reverseButtons) {
					buttons +=
						...
						'<button class="btn btn-default" id="'+f.type+'-cancel-'+f.newid+'" class="cancel">'+cancel+'</button>';				
				} else {
					buttons +=
						'<button class="btn btn-primary" id="'+f.type+'-cancel-'+f.newid+'" class="cancel">'+cancel+'</button>'+
						'<button class="btn btn-default" id="'+f.type+'-ok-'+f.newid+'">'+ok+'</button>';
				}
			}
			buttons += '</div>';
		}
