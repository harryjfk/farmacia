...
<script>
    ...
    function cambiarEstadoUnidadMedida(id, e, element) {
        ...
        smokeConfirm('¿Está seguro que desea cambiar de estado la unidad de medida ' + unidadMedidaTexto + '?', function(e) {
            if (e) {
                $.ajax({
    ...
    function eliminarUnidadMedida(id, e, element) {
        ...
        smokeConfirm('¿Está seguro que desea eliminar la unidad de medida ' + unidadMedidaTexto + '?', function(e) {
            if (e) {
                $.ajax({
