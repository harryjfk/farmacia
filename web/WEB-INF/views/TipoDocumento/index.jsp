...
<script>
    ...
    function cambiarEstadoTipoDocumento(id, e, element) {
        ...
        smokeConfirm('¿Está seguro que desea cambiar de estado el tipo de documento ' + tipoDocumentoTexto + '?', function(e) {
            if (e) {
                $.ajax({
    ...
    function eliminarTipoDocumento(id, e, element) {
        ...
        smokeConfirm('¿Está seguro que desea eliminar el tipo de documento ' + tipoDocumentoTexto + '?', function(e) {
            if (e) {
                $.ajax({
