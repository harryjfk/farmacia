...
<h3 class="heading">Listado de Medicamentos adquiridos</h3>
...
<script>
    ...
    $('#btnExcel').click(function(e) {
        ...
        //window.location = getUrlConsultaExcel("excelMedicamento", dataTable);
    });
    ...
    $('#btnPDF').click(function(e) {
        ...
        //window.location = getUrlConsultaPDF("pdfMedicamento", dataTable);
    });
    ...
    function listarDetalleMed() {
        $(tblDetalleMed).dataTable({
            "fnServerParams": function(aoData) {
                ...
                aoData.push({"name": 'tipoConsulta', "value": "1"});
            },
