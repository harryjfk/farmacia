...
<script>
    ...
    function cambiarEstadoTipoAlmacen(id, e, element) {
        ...
        smokeConfirm('¿Está seguro que desea cambiar de estado el tipo de almacen ' + tipoAlmacenTexto + '?', function(e) {
            if (e) {
                $.ajax({
    ...
    function eliminarTipoAlmacen(id, e, element) {
        ...
        smokeConfirm('¿Está seguro que desea eliminar el tipo de almacen ' + tipoAlmacenTexto + '?', function(e) {
            if (e) {
                $.ajax({
