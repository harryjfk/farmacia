...
<h3 class="heading">Mantenimiento de Ubigeos
    ...
    <div class="col-sm-10 col-md-10">
        ...
        <c:if test="${not empty param.idUbigeo}">
            <c:if test="${fn:length(param.idUbigeo) == 2}">
                <a href="<c:url value="/Ubigeo/listar" />">Regresar a Departamentos</a>
            </c:if>

            <c:if test="${fn:length(param.idUbigeo) == 4}">
                <a href="<c:url value="/Ubigeo/listar" />?idUbigeo=${fn:substring(param.idUbigeo, 0, 2)}">Regresar a Provincias</a>
            </c:if>
        </c:if>
    </div>
</div>
...
<script>
    ...
    <c:if test="${empty param.idUbigeo}">
                        enlaceSubUbigeo = '<a href="<c:url value="/Ubigeo/listar" />?idUbigeo=' + data + '" class="separator-icon-td">Ver Provincias</a>';
    </c:if>

    <c:if test="${not empty param.idUbigeo}">
        <c:if test="${fn:length(param.idUbigeo) == 2}">
                        enlaceSubUbigeo = '<a href="<c:url value="/Ubigeo/listar" />?idUbigeo=' + data + '" class="separator-icon-td">Ver Distrito</a>';
        </c:if>
    </c:if>
