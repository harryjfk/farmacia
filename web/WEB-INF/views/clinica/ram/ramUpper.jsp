...
<div class="row"> 
    ...
    <div style="margin-bottom:15px;">
        ...
        <button id="borrarHoja"class="btn btn-danger">Eliminar</button>
    ...
    <form id="ramForm" class="form_validation_reg form-horizontal" autocomplete="off">
        ...
        <div class="col-sm-12 col-md-12 col-lg-12 col-xs-12 form-frame">
            ...
            <div class="form-group">
                <label for="paciente" class="col-md-2 col-sm-2 col-lg-2 col-xs-2 control-label">Nombre</label>
                <div class="col-md-10 col-sm-10 col-lg-10 col-xs-10">
                    <input id="paciente" name="paciente" class="form-control" />
                </div>
            </div>
            <div class="form-group">
                <label for="establecimiento" class="col-md-2 col-sm-2 col-lg-2 col-xs-2 control-label">Establecimiento de Salud</label>
                <div class="col-md-10 col-sm-10 col-lg-10 col-xs-10">
        ...
        <div class="col-sm-12 col-md-12 col-lg-12 col-xs-12 form-frame" >
            ...
            <div class="form-group">
                <label for="observaciones" class="col-md-2 col-sm-2 col-lg-2 col-xs-1 control-label">Observaciones</label>
                <div class="col-md-10 col-sm-10 col-lg-10 col-xs-10">
    ...
    <div>
        <button id="btn-agregarMedicamentos" class="btn btn-primary"  >Agregar Medicamentos Sospechosos</button>
    </div>
    <div class="col-sm-12 col-md-12 col-lg-12 col-xs-12 form-frame" >
    ...
    <div>
        <button id="btn-agregarReacciones" class="btn btn-primary" >Agregar Reacciones Adversas</button>
    </div>
    <div class="col-sm-12 col-md-12 col-lg-12 col-xs-12 form-frame" >
    ...
    <div>
        <button id="btn-agregarOtros" class="btn btn-primary">Agregar Otros Medicamentos</button>
    </div>
    <div class="col-sm-12 col-md-12 col-lg-12 col-xs-12 form-frame" >
        <h4>Otros Medicamentos Usados en los Ultimos 3 Meses incluyendo Automedicación</h4>
