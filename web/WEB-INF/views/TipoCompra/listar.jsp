...
<script>
    ...
    function cambiarEstadoTipoCompra(id, e, element) {
        ...
        smoke.confirm('¿Está seguro que desea cambiar de estado el tipo de compra ' + tipoCompraTexto + '?', function(e) {
            if (e) {
                $.ajax({
                    url: 'estado/' + id,
                    type: 'POST',
    ...
    function eliminarTipoCompra(id, e, element) {
        ...
        smoke.confirm('¿Está seguro que desea eliminar el tipo de compra ' + tipoCompraTexto + '?', function(e) {
            if (e) {
                $.ajax({
                    url: 'eliminar/' + id,
                    type: 'POST',
