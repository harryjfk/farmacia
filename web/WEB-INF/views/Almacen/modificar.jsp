        ...
        <div class="formSep">
            <div class="row">
                <div class="col-sm-4 col-md-4">
                    ...
                    <input type="text" id="descripcion" class="form-control" maxlength="50" data-req="" value="${almacen.descripcion}"/>
                </div>
                <div class="col-sm-2 col-md-2">
                    <label>Abreviatura <span class="f_req">*</span></label>
                    <input type="text" id="abreviatura" class="form-control" maxlength="10" data-req="" value="${almacen.abreviatura}"/>
                </div>
                <div class="col-sm-2 col-md-2">
                    <label>Ruc</label>
                    <input type="text" id="ruc" class="form-control" maxlength="11" value="${almacen.ruc}"/>
                </div>
                <div class="col-sm-4 col-md-4">
                    <label>Responsable</label>
                    <div class="input-group">
                        <input type="text" id="responsable" class="form-control" maxlength="70" value="${almacen.responsable}"/>
        ...
        <div class="formSep">
            <div class="row">
                <div class="col-sm-3 col-md-3">
                    <label>Fax</label>
                    <input type="text" id="fax" class="form-control" maxlength="20" value="${almacen.fax}"/>
                </div>
                <div class="col-sm-3 col-md-3">
                    <label>Teléfono</label>
                    <input type="text" id="telefono" class="form-control" maxlength="20" value="${almacen.telefono}"/>
                </div>
                <div class="col-sm-6 col-md-6">
                    <label>Dirección</label>
                    <input type="text" id="direccion" class="form-control" maxlength="50" value="${almacen.direccion}"/>
                </div> 
            </div>
        </div>
        <div class="formSep">
                ...
                <div class="col-sm-4 col-md-4">
                    ...
                    <select id="selDepartamento" class="form-control">
                        ...
                        <c:forEach var="departamento" items="${departamentos}">
                            <option value="${departamento.idUbigeo}" <c:if test="${departamento.idUbigeo == fn:substring(almacen.idUbigeo, 0, 2)}"> selected="selected" </c:if> >${departamento.nombreUbigeo}</option>
                        </c:forEach>
                    </select>
                </div>
                <div class="col-sm-4 col-md-4">
                    ...
                    <select id="selProvincia" class="form-control">
                        ...
                        <c:forEach var="provincia" items="${provincias}">
                            <option value="${provincia.idUbigeo}" <c:if test="${provincia.idUbigeo == fn:substring(almacen.idUbigeo, 0, 4)}"> selected="selected" </c:if> >${provincia.nombreUbigeo}</option>
                        </c:forEach>
                    </select>
                </div>
                <div class="col-sm-4 col-md-4">
                    ...
                    <select id="selDistrito" class="form-control">
                        ...
                        <c:forEach var="distrito" items="${distritos}">
                            <option value="${distrito.idUbigeo}" <c:if test="${distrito.idUbigeo == almacen.idUbigeo}"> selected="selected" </c:if> >${distrito.nombreUbigeo}</option>
                        </c:forEach>
                    </select>
                </div>
            </div>
        ...
        <div class="formSep">
            <div class="row">
                <div class="col-sm-3 col-md-3">
                    ...
                    <select id="selTipoAlmacen" class="form-control" data-req="">
                        <c:forEach var="tipoAlmacen" items="${tiposAlmacen}">                                
                            <option value="${tipoAlmacen.idTipoAlmacen}"<c:if test="${tipoAlmacen.idTipoAlmacen == almacen.idTipoAlmacen}"> selected="" </c:if>>${tipoAlmacen.nombreTipoAlmacen}</option>
                        </c:forEach>
                    </select>
                </div>
                <div class="col-sm-3 col-md-3">
                ...
                <div class="col-sm-3 col-md-3">                        
                    ...
                    <input type="text" id="codigoAlmacen" class="form-control" maxlength="10" value="${almacen.codigoAlmacen}" data-req=""/>
                </div>
                <div class="col-sm-2 col-md-2">                    
                    <label>Estado <span class="f_req">*</span></label>
                    <div class="separator-form-checkbox"></div>
                    <label class="checkbox-inline">
                        <input type="checkbox" id="activo" value="1" data-unchecked="0" <c:if test="${almacen.activo == 1}"> checked="checked" </c:if> /> Activo
                    </label>
                </div>
            </div>
        </div>
...
<script>
    ...
    $('#btnCancelar').click(function(e) {
        ...
        <c:if test="${not empty almacen.idAlmacenPadre}">
            window.location = '<c:url value="/Almacen/subalmacen/" />${almacen.idAlmacenPadre}';        
        </c:if>
        <c:if test="${empty almacen.idAlmacenPadre}">
    ...
    $('#btnGuardar').click(function(e) {
        ...
        var almacen = {
            ...
            codigoAlmacen: $('#codigoAlmacen').val(),
            activo: $('#activo').checkboxVal()<c:if test="${not empty almacen.idAlmacenPadre}">,
            idAlmacenPadre: <c:out value="${almacen.idAlmacenPadre}" />
            </c:if>
        };
        
        $.ajax({
            url: '<c:url value="/Almacen/modificar"/>',
